    ...
    render() {
        ...
        return (
            <div>
               ...
               <br/>
               <div>
                   {this.state.status === "Playing" && <GuessButtons targetWord={this.props.targetWord} letterClick={this.checkLetterHandler}/>}
               </div>
            </div>
        )
    }
...
class Hangman extends React.Component {
    ...
    componentDidMount() {
        fetch('https://api.wordnik.com/v4/words.json/randomWords?hasDictionaryDef=true&maxCorpusCount=-1&minDictionaryCount=1&maxDictionaryCount=-1&minLength=5&maxLength=-1&limit=1&api_key=zswceep3r92i95s92ilst9cs9v6di88s1ztca17i8oez2fhaj')
